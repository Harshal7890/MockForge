import { GoogleGenerativeAI } from "@google/generative-ai"; // Updated package and class name
import { INTERVIEW_PROMPT, EVALUATION_PROMPT, APTITUDE_EVALUATION_PROMPT } from "./prompts";

// Initialize with just the string key
const genAI = new GoogleGenerativeAI(process.env.GEMINI_API_KEY);

// Now getGenerativeModel will work correctly
